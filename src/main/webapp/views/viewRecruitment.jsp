                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb align-items-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    ${jobDetail.company.account.fullName}</li>
                            </ol>
                        </nav>
                    </div>
                    <div style="
...
>>>>>>> b988a6d16d80c22959926c7747c0b2007c375c83
                                                <c:forEach var="o" items="${cvList}">
                                                    <option value="${o.id}">${o.name}</option>
                                                </c:forEach>
                                                <option value="/student/CVs"><a href="/student/CVs">Other</a></option>
                                            </select>
                                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-2 mb-2 mr-2">
                                <h3>Qualification:</h3>
                                <textarea rows="5" class="w-100 p-3 overflow-auto" style="font-size: 25px;"
                                    disabled><c:forEach items="${jobRe}" var="o">• ${o}</c:forEach></textarea>
                            </div>
                            <div class="col-12 mt-2 mb-2 mr-2">
                                <h3>Benefit:</h3>
                                <textarea rows="5" class="w-100 p-3 overflow-auto" style="font-size: 25px;"
                    ...
                    <script>
                        ...
                        $(document).ready(function () {
                            $("#selection").change(function () {
                                ...
                                if (curVal.indexOf('/student/CVs') === 0) {
