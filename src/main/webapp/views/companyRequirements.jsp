                                                                    ...
                                                                    <div class="modal-body text-center">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <textarea class="form-control"
                                                                                ...
                                                                                name="description"
                                                                                required>${o.description}</textarea>
                                                                        </div>
                                                                        <div class="input-group mb-3">
                                                                            <span class="input-group-text"
                                                                                id="basic-addon1">Requirement</span>
                                                                            <textarea class="form-control"
                                                                                id="requirement" rows="3"
                                                                                value="${o.requirement}"
                                                                                placeholder="Enter Requirement"
                                                                                name="requirement"
                                                                                required>${o.requirement}</textarea>
                                                                        </div>
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <textarea type="text" rows="3" class="form-control"
                                                                                id="benefit" value="${o.benefit}"
                                                                                placeholder="Enter Benefit"
                                                                                name="benefit"
                                                                                required>${o.benefit}</textarea>
                                                                        </div>
                                                                        <div class="input-group mb-3">
                                                                            <span class="input-group-text"
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input class="form-control" id="position"
                                                                    name="position" value="${o.position.position}"
                                                                    disabled>
                                                            </div>
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <span class="input-group-text"
                                                                    id="basic-addon1">Requirement</span>
                                                                <textarea class="form-control" rows="3" id="requirement"
                                                                    placeholder="Enter Requirement" name="requirement"
                                                                    value="${o.requirement}"
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <span class="input-group-text"
                                                                    id="basic-addon1">Benefit</span>
                                                                <textarea class="form-control" rows="3" id="benefit"
                                                                    placeholder="Enter Benefit" name="benefit"
                                                                    value="${o.benefit}"
