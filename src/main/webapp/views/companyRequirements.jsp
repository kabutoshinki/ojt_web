                                ...
                                <div class="modal-content text-center">
                                    ...
                                    <div class="modal-body text-center">
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="position" class="form-select form-select-lg mb-3 btn btn-primary btn-lg btn-block mt-3" id="position" aria-label=".form-select-lg example">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" id="slot" min="1" max="100"
                                                   placeholder="Enter Slot" name="slot" required>
                                        </div>
