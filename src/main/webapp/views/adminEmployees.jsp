                    ...
                    <table id="myTable" class="table table-bordered">
                        ...
                        <c:forEach items="${employeeList}" var="o" varStatus="loop">
                            <tr>
                                ...
                                <td>
                                    <a href="mailto: ${o.account.email}" class="text-truncate" style="max-width: 150px;" title="${o.account.email}">
                                        ${o.account.email}
                                    </a>
                                </td>
                                <td class="text-truncate" style="max-width: 150px;" title="${o.account.phone}">
                                        ${o.account.phone}
                                </td>
