    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        ...
        <body>
            <%@include file="header.jsp" %>
                ...
                <form action="/account/updateInformation" ModelAttribute="information" enctype="multipart/form-data"
                    method="POST">
                            ...
                            <div class="col-12 col-lg-4 border-right">
                                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                    <figure class="snip1336">
                                        <figcaption>
                                            <img src="${user.avatar==null?'/img/avatar.png':user.avatar}"
                                                alt="profile-sample4" style="width: 300px;height: 300px;"
                                                class="profile img-fluid mt-5 pt-5" id="thumbnail" /><br />
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="fullName" id="name" type="text" class="form-control"
                                                    value="${user.fullName}" placeholder="Full Name" readonly />
                                            </div>
                                        </div>
                                       ...
                                       value="${user.address}" placeholder="Address"/> -->
                                                <textarea name="address" id="address" type="text" class="form-control"
                                                    value="${user.address}" placeholder="Address"></textarea>
                                            </div>
                                        </div>
