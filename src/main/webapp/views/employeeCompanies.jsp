                                                    ...
                                                    <div class="input-group mt-3 mb-3">
                                                        <div class="input-group-prepend">
                                                            <label class="input-group-text"
                                                                for="inputGroupSelect01">Filter</label>
                                                        </div>
                                            ...
                                            <div class="modal-content text-center">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-sm btn-outline-success"><i
                                                            class="bi bi-check-circle"></i> Import
                                                    </button>
                                                    ...
                                                    <tr style="text-align: center;">
                                                        ...
                                                        <td>
                                                            <button class="btn btn-outline-info btn-sm"
                                                                data-toggle="modal" data-target="#inforModal_${o.id}"><i
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            value="${o.account.fullName}" disabled>
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <input type="email" class="form-control"
                                                                            ...
                                                                            value="${o.account.email}" disabled>
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <input type="tel" class="form-control"
                                                                            ...
                                                                            value="${o.account.phone}" disabled>
                                                                    </div>
