                    ...
                    <table id="myTable" class="table table-bordered">
                        ...
                        <c:forEach items="${processList}" var="o" varStatus="loop">
                            <tr>
                                ...
                                <td class="text-truncate" style="max-width: 150px;"
                                    title="${o.application.job.company.account.fullName}">${o.application.job.company.account.fullName}</td>
                                <td class="text-truncate" style="max-width: 150px;"
                                    title="${o.application.job.position.position}">${o.application.job.position.position}</td>
                                <td>${o.startDate}</td>
                                <td>${o.endDate}</td>
                                <td>
                                    <a href="/view/evaluate/${o.id}"
