        ...
        <div class="col-lg-8">
            <div class="p-3 py-5">
                ...
                <div class="input-group">
                            <textarea class="form-control" rows="4" name="jobDescription" disabled
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" rows="4" name="knowledge" disabled
                                                              aria-label="With textarea" value="${process.knowledge}"
                                                              required>${process.knowledge}</textarea>
                                    </div>
                                </td>
                                <td>
                                    <div class="dropdown text-center btn-lg btn-block">
                                        <select name="point1" disabled
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" rows="4" name="softSkill" disabled
                                                              aria-label="With textarea" value="${process.softSkill}"
                                                              required>${process.softSkill}</textarea>
                                    </div>
                                </td>
                                <td>
                                    <div class="dropdown text-center btn-lg btn-block">
                                        <select name="point2" disabled
                                                class="form-select form-select-lg mb-3 btn btn-primary btn-lg btn-block mt-3"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" rows="4" name="attitude" disabled
                                                              aria-label="With textarea" value="${process.attitude}"
                                ...
                                <td>
                                    <div class="dropdown text-center btn-lg btn-block">
                                        <select name="point3"
                                                class="form-select form-select-lg mb-3 btn btn-primary btn-lg btn-block mt-3"
                                                id="grade4" aria-label=".form-select-lg example" disabled
                                                required>
