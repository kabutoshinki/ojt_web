            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb align-items-center">
                        ...
                        <li class="breadcrumb-item" style="padding:0;display: ${account.role.equals('EMPLOYEE')=='true'?'':'none'}">
                            <a href="/employee" style="padding:0;display: inline">
                                Employee
                            </a>
                         </li>
                        <li class="breadcrumb-item" style="padding:0;display: ${account.role.equals('EMPLOYEE')=='true'?'':'none'}"><a href="/employee/studentResult" style="padding:0;display: inline">Student_Internship_Result</a></li>
                        <li class="breadcrumb-item" style="padding:0;display: ${account.role.equals('STUDENT')=='true'?'':'none'}"><a href="/student/report" style="padding:0;display: inline">Internship_Report</a></li>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <textarea class="form-control" rows="4" name="description_1"
                                                                aria-label="With textarea" disabled>Good</textarea>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="dropdown text-center btn-lg btn-block">
                                                            <select
                                                                class="form-select form-select-lg mb-3 btn btn-primary btn-lg btn-block mt-3"
                                                                id="grade2" aria-label=".form-select-lg example" disabled>
                                                                <option value="" class="text-center">Grade
                                                                </option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <textarea class="form-control" rows="4" id="description_3" name="description_3"
                                                                aria-label="With textarea" disabled>Good</textarea>
                                                        </div>
                                                    </td>
                                                    <td>
