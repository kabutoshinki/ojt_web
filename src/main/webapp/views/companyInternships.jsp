                                                            ...
                                                            <div class="modal-body text-center">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <textarea class="form-control" id="description"
                                                                        ...
                                                                        name="description" value="" disabled></textarea>
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="col-3 input-group mb-3">
                                                                        <select name="point2" class="custom-select"
                                                                            ...
                                                                            required>
                                                                            <option value="1"
                                                                                ${process.softSkillPoint==1?"selected":""}>
                                                                                1
                                                                            </option>
                                                                            <option value="2"
                                                                                ${process.softSkillPoint==2?"selected":""}>
                                                                                2
                                                                            </option>
                                                                            <option value="3"
                                                                                ${process.softSkillPoint==3?"selected":""}>
                                                                                3
                                                                            </option>
                                                                            <option value="4"
                                                                                ${process.softSkillPoint==4?"selected":""}>
                                                                                4
                                                                            </option>
                                                                            <option value="5"
                                                                                ${process.softSkillPoint==5?"selected":""}>
                                                                                5
                                                                            </option>
                                                                            <option value="6"
                                                                                ${process.softSkillPoint==6?"selected":""}>
                                                                                6
                                                                            </option>
                                                                            <option value="7"
                                                                                ${process.softSkillPoint==7?"selected":""}>
                                                                                7
                                                                            </option>
                                                                            <option value="8"
                                                                                ${process.softSkillPoint==8?"selected":""}>
                                                                                8
                                                                            </option>
                                                                            <option value="9"
                                                                                ${process.softSkillPoint==9?"selected":""}>
                                                                                9
                                                                            </option>
                                                                            <option value="10"
                                                                                ${process.softSkillPoint==10?"selected":""}>
                                                                                10
                                                                            </option>
                                                                        </select>
                                                                    </div>
