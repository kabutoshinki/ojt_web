    ...
    <div class="d-flex flex-grow-1 p-1 info">
        ...
        <div class="dropdown">
           ...
           <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
             ...
             <a class="dropdown-item" href="/studentController/viewApply" style="display: ${account.role.equals('STUDENT')=='true'?'':'none'}"><i class="bi bi-box-arrow-left"></i> View Apply</a>
