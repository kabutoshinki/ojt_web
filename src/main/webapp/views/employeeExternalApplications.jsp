                    ...
                    <table id="myTable" class="table table-bordered">
                        ...
                        <c:forEach items="${applyList}" var="o" varStatus="loop">
                            <tr>
                                ...
                                <td class="text-truncate" style="max-width: 150px;"
                                    title="${o.key.student.account.fullName}">
                                        ${o.key.student.account.fullName}</td>
                                <td>
                            ...
                            <div class="modal fade" id="evaluateModal_${o.key.id}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content text-center">
                                        <form action="/employee/updateExternalEvaluate/${o.key.id}">
                                            ...
                                            <div class="modal-body text-center">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        ...
                                                        ${o.value.status=="Passed" || o.value.status == "Not Passed"?"disabled":""}
                                                           name="startDate" required>
                                                </div>
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text" id="basic-addon1">End date</span>
                                                    <input type="date" class="form-control"
                                                           id="endDate" value="${o.value.endDate}"
                                                ...
                                                <div class="form-row">
                                                    <div class="col-9 input-group mb-3">
                                                        ...
                                                        <textarea class="form-control" id="requirement"
                                                                  ...
                                                                  name="attitude" value="${o.value.attitude}"
                                                                  required ${o.value.status=="Passed" || o.value.status == "Not Passed"?"disabled":""}>${o.value.attitude}</textarea>
                                                    </div>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="total"
                                                           value="${o.value.grade}" name="total" disabled>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit"
                                                        class="btn btn-outline-success" ${o.value.status=="Passed" || o.value.status == "Not Passed"?"hidden":""}
                                    ...
                                    <div class="modal-content text-center">
                                        <div class="modal-header"
                                            ...
                                            <h5 class="modal-title"
                                                id="exampleModalLabel">${o.key.companyName}
                                            </h5>
                                        </div>
                                        <div class="modal-body text-center">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="email" class="form-control"
                                                       ...
                                                       value="${o.key.companyEmail}" disabled>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="tel" class="form-control"
                                                       id="companyPhone"
                                                       name="companyPhone"
                                                       value="${o.key.companyPhone}" disabled>
                                            </div>
                            ...
                            <div class="modal fade" id="acceptModal${o.key.id}"
                                 ...
                                 aria-hidden="true">
                                <div class="modal-dialog">
                                    <form action="verifyExternalApplication/${o.key.id}/Accepted">
                                        <div class="modal-content text-center">
                                            <div class="modal-header"
                                                 style="background: orange; text-align: center; display: unset;">
                                                <h5 class="modal-title"
                            ...
                            <!-- Deny Modal -->
                            <div class="modal fade" id="denyModal${o.key.id}" tabindex="-1"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form action="verifyExternalApplication/${o.key.id}/Denied">
                                        <div class="modal-content text-center">
                                            <div class="modal-header"
                                                 style="background: orange; text-align: center; display: unset;">
                                                <h5 class="modal-title"
                                            ...
                                            <h4>Are you sure you want to deny this application</h4>
                                            <div class="modal-footer">
                                                <button type="submit"
