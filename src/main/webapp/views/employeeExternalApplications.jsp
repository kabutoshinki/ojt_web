...
<div class="container">
    ...
    <div class="container" style="justify-content: center;">
        <div>
                            ...
                            <div class="modal-body text-center">
                                <div class="input-group mt-3 mb-3">
                                    ...
                                    <select class="custom-select" id="inputGroupSelect01"
                                        ...
                                        <option value="Denied" ${statusValue=="Denied"?"selected":""}}>Denied</option>
            ...
            <button type="button" class="btn btn-outline-info ml-2 mb-3" data-toggle="modal" data-target="#filter"
                    style="float: right;">
