                    ...
                    <table id="myTable" class="table table-bordered">
                        ...
                        <c:forEach items="${applyList}" var="o" varStatus="loop">
                            <tr>
                                ...
                                <td title="${o.key.application.message}">${o.key.application.status}</td>
                                <td class="text-truncate" style="max-width: 150px;"
                                ...
                                <td>
                                    ...
                                    <button
                                            ...
                                            style="${o.key.application.status=='Waiting'?'':'pointer-events: none; background-color: lightgrey'}"
                            ...
                            <div class="modal fade" id="acceptModal${o.key.id}"
                                ...
                                <div class="modal-dialog">
                                    <form
                                            action="verifyExternalApplication/${o.key.id}/Interning">
                                        <div class="modal-content text-center">
                                            <div class="modal-header"
                                                 style="background: orange; text-align: center; display: unset;">
                                                <h5 class="modal-title"
                                        ...
                                        <div class="modal-content text-center">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <textarea class="form-control" id="message"
                                                          ...
                                                          value="${o.key.application.message}">${o.key.application.message}</textarea>
