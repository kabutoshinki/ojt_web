                            ...
                            <div class="modal-body text-center">
                                <div class="input-group mt-3 mb-3">
                                    ...
                                    <select class="custom-select" id="inputGroupSelect01"
                                        ...
                                        <option value="Waiting" ${statusValue.equals("Waiting")?"selected":""}}>Waiting</option>
                                        <option value="Processing" ${statusValue.equals("Processing")?"selected":""}}>Processing</option>
                                        <option value="Denied" ${statusValue.equals("Denied")?"selected":""}}>Denied</option>
                                        <option value="Interviewing" ${statusValue.equals("Interviewing")?"selected":""}}>Interviewing</option>
                                        <option value="Passed Interviewing" ${statusValue.equals("Passed Interviewing")?"selected":""}}>Passed Interviewing</option>
                                        <option value="Interning" ${statusValue.equals("Interning")?"selected":""}}>Interning</option>
                                        <option value="Completed" ${statusValue.equals("Completed")?"selected":""}}>Completed</option>
                                    </select>
                                </div>
                            </div>
