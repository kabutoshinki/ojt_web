...
<div class="wrapper">
    ...
    <nav id="sidebar" class="">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="/employee/students" class="text-truncate"
                   style="display: ${account.role.equals('EMPLOYEE')=='true' || account.role.equals('ADMIN')=='true'?'':'none'}">
            ...
            <li>
                <a href="/employee/companies" class="text-truncate"
                   style="display: ${account.role.equals('EMPLOYEE')=='true' || account.role.equals('ADMIN')=='true'?'':'none'}">
            ...
            <li>
                <a href="/employee/requirements" class="text-truncate"
                   style="display: ${account.role.equals('EMPLOYEE')=='true' || account.role.equals('ADMIN')=='true'?'':'none'}">
            ...
            <li>
                <a href="/employee/applications" class="text-truncate"
                   style="display: ${account.role.equals('EMPLOYEE')=='true' || account.role.equals('ADMIN')=='true'?'':'none'}">
            ...
            <li>
                <a href="/employee/externalApplications" class="text-truncate"
                   style="display: ${account.role.equals('EMPLOYEE')=='true' || account.role.equals('ADMIN')=='true'?'':'none'}">
            ...
            <li>
                <a href="/employee/internships" class="text-truncate"
                   style="display: ${account.role.equals('EMPLOYEE')=='true' || account.role.equals('ADMIN')=='true'?'':'none'}">
